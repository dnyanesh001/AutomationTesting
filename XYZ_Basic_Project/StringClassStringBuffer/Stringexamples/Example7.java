...
public class Example7 {
	public static void main(String [] args) {
		String s1="I am from UP, I am WOrking in Accenture, I working as QA Deleivery Head";
		...
		System.out.println("Acctual String : "+s3);
		String str[]=s3.split(" ");
		String temp="";
		...
		System.out.println("Actual Strng length : "+ s5.trim().length());
